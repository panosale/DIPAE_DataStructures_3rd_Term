public class ArrayStack implements StackInterface {
    ...
    public void pushStackElement(Object element) throws StackFullException {
        ...
        this.S[++this.top] = element; // ΠΡΟΣΟΧΗ! Πρώτα αυξάνει το top και μετά εισάγει το στοιχείο (item) στον πίνακα
