// Άσκηση 2.1 & 2.2. Η Στοίβα χειρίζεται μόνο αντικείμενα τύπου Objet (πιο γενική χρήση)
// Παράδειγμα στοίβας σε Java
public class Main {
    public static void main(String[] args) {
        System.out.println("***** Άσκηση 2.1 & 2.2. Η Στοίβα χειρίζεται μόνο αντικείμενα τύπου Objet (πιο γενική χρήση) *****");
